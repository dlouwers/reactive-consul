...
import com.crobox.reactiveconsul.client.dao.{AcquireSession, BinaryData, ConsulHttpClient, KeyData}
import com.crobox.reactiveconsul.client.election.LeaderFollowerActor.Participate
